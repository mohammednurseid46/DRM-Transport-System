...
import { Zap, Mail, Lock, AlertCircle, ArrowLeft, X, Eye, EyeOff } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-black/20 py-3 pl-10 pr-10 text-sm text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-slate-900 dark:text-white placeholder-gray-500 focus:border-dms-primary focus:outline-none focus:ring-1 focus:ring-dms-primary transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
